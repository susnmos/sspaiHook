...
@class BAFHTTPRequestSerializer<BAFURLRequestSerialization>, BAFHTTPResponseSerializer<BAFURLResponseSerialization>, BAFNetworkReachabilityManager, BAFSecurityPolicy, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSOperationQueue, NSURL, NSURLCredential;

@interface BAFHTTPRequestOperationManager : NSObject <NSSecureCoding, NSCopying>
{
    _Bool _shouldUseCredentialStorage;
    NSURL *_baseURL;
    BAFHTTPRequestSerializer<BAFURLRequestSerialization> *_requestSerializer;
    BAFHTTPResponseSerializer<BAFURLResponseSerialization> *_responseSerializer;
    NSOperationQueue *_operationQueue;
    NSURLCredential *_credential;
    BAFSecurityPolicy *_securityPolicy;
...
@property(retain, nonatomic) BAFHTTPRequestSerializer<BAFURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
@property(retain, nonatomic) BAFHTTPResponseSerializer<BAFURLResponseSerialization> *responseSerializer; // @synthesize responseSerializer=_responseSerializer;
@property(retain, nonatomic) BAFSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
