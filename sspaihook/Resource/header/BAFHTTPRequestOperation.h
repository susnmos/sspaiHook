...
#import "BAFURLConnectionOperation.h"

@class BAFHTTPResponseSerializer<BAFURLResponseSerialization>, NSError, NSHTTPURLResponse, NSRecursiveLock;

@interface BAFHTTPRequestOperation : BAFURLConnectionOperation
{
