...
@interface MASG3Constraint : NSObject
{
    ...
    id <MASG3ConstraintDelegate> _delegate;
}
...
- (void)deactivate;
@property(nonatomic) __weak id <MASG3ConstraintDelegate> delegate; // @synthesize delegate=_delegate;
...
- (CDUnknownBlockType)masG3_equalTo;
- (CDUnknownBlockType)masG3_greaterThanOrEqualTo;
- (CDUnknownBlockType)masG3_lessThanOrEqualTo;
- (CDUnknownBlockType)masG3_offset;
