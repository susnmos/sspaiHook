...
@class Growing3rdLib_Growing3rdLib_SRIOConsumerPool, NSArray, NSInputStream, NSMutableArray, NSMutableData, NSMutableSet, NSObject<OS_dispatch_queue>, NSOperationQueue, NSOutputStream, NSString, NSURL, NSURLRequest;
...
@interface Growing3rdLibSRWebSocket : NSObject <NSStreamDelegate>
{
    ...
    Growing3rdLibSRWebSocket *_selfRetain;
    NSArray *_requestedProtocols;
    Growing3rdLib_Growing3rdLib_SRIOConsumerPool *_consumerPool;
    id <Growing3rdLibSRWebSocketDelegate> _delegate;
    NSURL *_url;
...
- (void)dealloc;
@property(nonatomic) __weak id <Growing3rdLibSRWebSocketDelegate> delegate; // @synthesize delegate=_delegate;
