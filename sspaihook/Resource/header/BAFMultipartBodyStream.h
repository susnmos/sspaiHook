...
@class BAFHTTPBodyPart, NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString;

@interface BAFMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    BAFHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) BAFHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
